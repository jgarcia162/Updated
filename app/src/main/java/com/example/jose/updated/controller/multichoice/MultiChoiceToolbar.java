package com.example.jose.updated.controller.multichoice;
...
public class MultiChoiceToolbar {
    ...
    public static class Builder {
        ...
        private String mDefaultToolbarTitle = "";
        private @PluralsRes
        int mSelectedQuantityTitle = UpdatedConstants.INVALID_RES;
        private String mSelectedToolbarTitle = "";
        ...
        public MultiChoiceToolbar build() {
            if (mDefaultPrimaryColor == 0 || mDefaultPrimaryColorDark == 0) {
                mDefaultPrimaryColor = getDefaultColorFromContext(new int[]{com.davidecirillo.multichoicerecyclerview.R.attr.colorPrimary});
                mDefaultPrimaryColorDark = getDefaultColorFromContext(new int[]{com.davidecirillo.multichoicerecyclerview.R.attr.colorPrimaryDark});
            }
